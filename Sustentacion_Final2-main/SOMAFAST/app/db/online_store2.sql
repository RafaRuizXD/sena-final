...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-10-2023 a las 02:32:47
...
(1, 'Nevera HACEB 12034', 'Es la mejor lavadora hasta el momento', 'https://tse3.mm.bing.net/th?id=OIP.j0QsMZwRuDNAkXGTKatgtAHaHa&pid=Api&P=0&h=180', 'La Nevera HACEB no frost de 226 Lts.', 1, '2023-08-31'),
(2, 'Lavadora  Lg', 'Ciclo Pre-Lavado + Normal, la lavdaora se encarga del lavado completo,Smart Motion ', 'https://www.tenerifeelectrodomesticos.com/10691-superlarge_default/lavadora-lg-inox.jpg', 'Lavadora LG Smart Inverter con 10 años de garantía, tiene un rendimiento de lavado superior, más limpio, más higiénico, El Motor Smart Inverter es confiable, silencioso y duradero', 1, '2023-08-31'),
...
(50, 'a', '', '', '', 2, '2023-08-31'),
(51, 'a', '', '', '', 2, '2023-08-31'),
(52, 'AB', 'abbbbb', 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAOEAAADhCAMAAAAJbSJIAAAAjVBMVEX///8AAAC9vb38/Pz4+Pjk5O', 'aaaaa', 2, '2023-08-31'),
(53, 'AB', 'abbbbb', 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAOEAAADhCAMAAAAJbSJIAAAAjVBMVEX///8AAAC9vb38/Pz4+Pjk5O', 'aaaaa', 2, '2023-08-31');
...
(10, 'Maicols', 'Mike', '$2y$10$S5f789RyiEL1dQPjAi0UH.WovE9hQ4HYJh2GR361mFc1Y20h6BwZS', 'msh112@a.a', 126547, 23554134, 1, 1, 0),
(11, 'MA', 'MAAA', '1', '1@A.A', 1, 23, 2, 2, 0),
(12, 'a', 'a', '1', 'a2@a.a', 123, 121312313, 2, 1, 0);
